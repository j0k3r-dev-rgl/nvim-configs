...
vim.keymap.set('n', '<C-s>', '<cmd>write<cr>', { desc = "Guardar archivo", silent = true })
vim.keymap.set('i', '<C-s>', '<Esc><cmd>write<cr>', { desc = "Guardar archivo", silent = true })
vim.keymap.set('v', '<C-s>', '<Esc><cmd>write<cr>', { desc = "Guardar archivo", silent = true })
